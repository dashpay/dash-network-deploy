...
async function generateAnsibleConfig(
  ...
  config.dashmate_version = '0.24.0-dev.13';
  ...
  config.withdrawals_hd_private_key = withdrawalsHDPrivateKey
    .toString();
  config.withdrawals_master_public_key = withdrawalsDerivedMasterPK
    .privateKey.toPublicKey().toString();
  config.withdrawals_second_public_key = withdrawalsDerivedSecondPK
    .privateKey.toPublicKey().toString();
