...
async function generateAnsibleConfig(
  ...
  config.dapi_envoy_image = 'dashpay/envoy:1.22.11';
  config.dashd_image = 'dashpay/dashd:latest-dev';
  config.tendermint_image = 'dashpay/tenderdash:latest';
  config.insight_api_image = 'dashpay/insight-api:4.0.5';
  config.insight_image = 'dashpay/insight-ui:4.0.5';
  config.multifaucet_image = 'dashpay/multifaucet:0.9.2';
  config.dashmate_version = '0.25.0-dev.27';
  ...
  async function generateDip3Keys(network) {
