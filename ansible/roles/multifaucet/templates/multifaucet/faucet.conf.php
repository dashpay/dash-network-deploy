...
$config = array(
        ...
        "minimum_payout" => 1000, // minimum to be awarded
        "maximum_payout" => 1000, // maximum to be awarded
        "payout_threshold" => 1000, // payout threshold, if the faucet contains less than this, display the 'dry_faucet' message
